...
phones = [
  ...
  %{
    ...
    specs: %{
      ...
      "camera_main_mp" => 48,
      "camera_ultrawide_mp" => 12,
      "camera_telephoto_mp" => 12,
      "front_camera_mp" => 12,
      "os" => "iOS 17",
      "weight_g" => 187,
      "thickness_mm" => 8.25,
  ...
  %{
    ...
    specs: %{
      ...
      "headphone_jack" => "No",
      "stability" => [
        %{"value" => "72%", "source" => "GSM Arena", "numeric_value" => 72.0},
        %{"value" => "67%", "source" => "AnandTech", "numeric_value" => 67.0}
      ]
    }
  },
  %{
    ...
    specs: %{
      ...
      "ip_rating" => "IP68",
      "headphone_jack" => "No",
      "stability" => [%{"value" => "70%", "source" => "GSM Arena", "numeric_value" => 70.0}]
    }
  },
  %{
    ...
    specs: %{
      ...
      "ip_rating" => "IP68",
      "headphone_jack" => "No",
      "stability" => [%{"value" => "76%", "source" => "GSM Arena", "numeric_value" => 76.0}]
    }
  },
  %{
    ...
    specs: %{
      ...
      "ip_rating" => "IP68",
      "headphone_jack" => "No",
      "stability" => [%{"value" => "69%", "source" => "GSM Arena", "numeric_value" => 69.0}]
    }
  },
  ...
  %{
    ...
    specs: %{
      ...
      "ip_rating" => "IP68",
      "headphone_jack" => "No",
      "stability" => [%{"value" => "77%", "source" => "GSM Arena", "numeric_value" => 77.0}]
    }
  },
  %{
  ...
  %{
    ...
    specs: %{
      ...
      "ip_rating" => "IP68",
      "headphone_jack" => "No",
      "stability" => [%{"value" => "80%", "source" => "GSM Arena", "numeric_value" => 80.0}]
    }
  },
  %{
    ...
    specs: %{
      ...
      "ip_rating" => "IP68",
      "headphone_jack" => "No",
      "stability" => [%{"value" => "73%", "source" => "GSM Arena", "numeric_value" => 73.0}]
    }
  },
  %{
    ...
    specs: %{
      ...
      "ip_rating" => "IP48",
      "headphone_jack" => "No",
      "stability" => [%{"value" => "75%", "source" => "GSM Arena", "numeric_value" => 75.0}]
    }
  },
  %{
    ...
    specs: %{
      ...
      "ip_rating" => "IP48",
      "headphone_jack" => "No",
      "stability" => [%{"value" => "71%", "source" => "GSM Arena", "numeric_value" => 71.0}]
    }
  },
  %{
    ...
    specs: %{
      ...
      "ip_rating" => "IP67",
      "headphone_jack" => "No",
      "stability" => [%{"value" => "65%", "source" => "GSM Arena", "numeric_value" => 65.0}]
    }
  },
  ...
  %{
    ...
    specs: %{
      ...
      "camera_main_mp" => 50,
      "camera_ultrawide_mp" => 48,
      "camera_telephoto_mp" => 48,
  ...
  %{
    ...
    specs: %{
      ...
      "ip_rating" => "IP67",
      "headphone_jack" => "No",
      "stability" => [%{"value" => "68%", "source" => "GSM Arena", "numeric_value" => 68.0}]
    }
  },
  %{
    ...
    specs: %{
      ...
      "camera_ultrawide_mp" => 12,
      "camera_telephoto_mp" => 48,
      "front_camera_mp" => 10.8,
      "os" => "Android 13",
      "weight_g" => 212,
      "thickness_mm" => 8.9,
      "ip_rating" => "IP68",
      "headphone_jack" => "No",
      "stability" => [%{"value" => "74%", "source" => "GSM Arena", "numeric_value" => 74.0}]
    }
  },
  %{
    slug: "google-pixel-7",
  ...
  %{
    ...
    specs: %{
      ...
      "ip_rating" => "IP68",
      "headphone_jack" => "No",
      "stability" => [%{"value" => "72%", "source" => "GSM Arena", "numeric_value" => 72.0}]
    }
  },
  %{
  ...
  %{
    ...
    specs: %{
      ...
      "ip_rating" => "IP68",
      "headphone_jack" => "No",
      "stability" => [%{"value" => "63%", "source" => "GSM Arena", "numeric_value" => 63.0}]
    }
  },
  ...
  %{
    ...
    specs: %{
      ...
      "ip_rating" => "IP54",
      "headphone_jack" => "No",
      "stability" => [%{"value" => "67%", "source" => "GSM Arena", "numeric_value" => 67.0}]
    }
  },
  %{
  ...
  %{
    ...
    specs: %{
      ...
      "ip_rating" => "IP68",
      "headphone_jack" => "No",
      "stability" => [%{"value" => "66%", "source" => "GSM Arena", "numeric_value" => 66.0}]
    }
  },
  %{
  ...
  %{
    ...
    specs: %{
      ...
      "battery_mah" => 5600,
      "charging_w" => 80,
      "wireless_charging" => "66W",
      "camera_main_mp" => 50,
      "camera_ultrawide_mp" => 50,
      "camera_telephoto_mp" => 180,
      "front_camera_mp" => 50,
      "os" => "Android 14",
      "weight_g" => 229,
      "thickness_mm" => 8.9,
  ...
  %{
    ...
    specs: %{
      ...
      "ip_rating" => "IP65",
      "headphone_jack" => "No",
      "stability" => [%{"value" => "64%", "source" => "GSM Arena", "numeric_value" => 64.0}]
    }
  },
...
benchmark_updates = [
  ...
  {"samsung-galaxy-s24-ultra",
   %{
     "gpu_score" => [
       %{"value" => "4532", "source" => "3DMark WLE", "numeric_value" => 70.0},
       %{"value" => "59% stability", "source" => "UL Benchmarks", "numeric_value" => 59.0}
     ],
     "cpu_score" => [%{"value" => "7142", "source" => "Geekbench 6", "numeric_value" => 71.0}],
     "battery_drain" => [
       %{"value" => "13h 49min", "source" => "GSM Arena", "numeric_value" => 69.0}
     ],
  ...
  {"samsung-galaxy-s24-plus",
   %{
     ...
     "battery_drain" => [
       %{"value" => "12h 30min", "source" => "GSM Arena", "numeric_value" => 63.0}
     ],
     "display_max_nits" => 2600
   }},
  {"samsung-galaxy-s24",
   %{
     ...
     "battery_drain" => [
       %{"value" => "12h 06min", "source" => "GSM Arena", "numeric_value" => 61.0}
     ],
     "display_max_nits" => 2600
   }},
  ...
  {"samsung-galaxy-z-fold6",
   %{
     ...
     "battery_drain" => [
       %{"value" => "11h 31min", "source" => "GSM Arena", "numeric_value" => 58.0}
     ],
     "display_max_nits" => 2600
   }},
  {"samsung-galaxy-z-flip6",
   %{
     ...
     "battery_drain" => [
       %{"value" => "10h 35min", "source" => "GSM Arena", "numeric_value" => 53.0}
     ],
     "display_max_nits" => 2600
   }},
  {"samsung-galaxy-a55",
   %{
     ...
     "battery_drain" => [
       %{"value" => "13h 27min", "source" => "GSM Arena", "numeric_value" => 67.0}
     ],
  ...
  {"apple-iphone-15",
   %{
     ...
     "battery_drain" => [
       %{"value" => "15h 30min", "source" => "GSM Arena", "numeric_value" => 78.0}
     ],
  ...
  {"google-pixel-9-pro-xl",
   %{
     ...
     "battery_drain" => [
       %{"value" => "12h 32min", "source" => "GSM Arena", "numeric_value" => 63.0}
     ],
  ...
  {"google-pixel-9-pro",
   %{
     ...
     "battery_drain" => [
       %{"value" => "13h 11min", "source" => "GSM Arena", "numeric_value" => 66.0}
     ],
     "display_max_nits" => 3000
   }},
  {"google-pixel-9",
   %{
     ...
     "battery_drain" => [
       %{"value" => "13h 05min", "source" => "GSM Arena", "numeric_value" => 65.0}
     ],
  ...
  {"google-pixel-8a",
   %{
     ...
     "battery_drain" => [
       %{"value" => "11h 25min", "source" => "GSM Arena", "numeric_value" => 57.0}
     ],
     "display_max_nits" => 2000
   }},
  {"google-pixel-7-pro",
  ...
  {"oneplus-12",
   %{
     "gpu_score" => [
       %{"value" => "4648", "source" => "3DMark WLE", "numeric_value" => 72.0},
       %{"value" => "83% stability", "source" => "UL Benchmarks", "numeric_value" => 83.0}
     ],
     "cpu_score" => [%{"value" => "6800", "source" => "Geekbench 6", "numeric_value" => 68.0}],
     "battery_drain" => [
       %{"value" => "11h 21min", "source" => "GSM Arena", "numeric_value" => 57.0}
     ],
  ...
  {"asus-zenfone-11-ultra",
   %{
     ...
     "battery_drain" => [
       %{"value" => "16h 28min", "source" => "GSM Arena", "numeric_value" => 82.0}
     ],
  ...
  {"asus-rog-phone-8",
   %{
     ...
     "battery_drain" => [
       %{"value" => "14h 43min", "source" => "GSM Arena", "numeric_value" => 74.0}
     ],
     "display_max_nits" => 2500
   }},
  ...
  {"sony-xperia-1-vi",
   %{
     ...
     "battery_drain" => [
       %{"value" => "17h 27min", "source" => "GSM Arena", "numeric_value" => 87.0}
     ],
     "display_max_nits" => 1300
   }},
  {"sony-xperia-5-v",
  ...
  {"honor-magic-6-pro",
   %{
     ...
     "cpu_score" => [%{"value" => "6800", "source" => "Geekbench 6", "numeric_value" => 68.0}],
     "battery_drain" => [
       %{"value" => "14h 06min", "source" => "GSM Arena", "numeric_value" => 71.0}
     ],
  ...
  {"oppo-find-x7-ultra",
   %{
     ...
     "battery_drain" => [
       %{"value" => "12h 47min", "source" => "GSM Arena", "numeric_value" => 64.0}
     ],
     "display_max_nits" => 4500
   }},
  ...
  {"nothing-phone-2a",
   %{
     ...
     "battery_drain" => [
       %{"value" => "15h 53min", "source" => "GSM Arena", "numeric_value" => 79.0}
     ],
     "display_max_nits" => 1300
   }},
  ...
  {"motorola-edge-50-pro",
   %{
     "battery_drain" => [
       %{"value" => "11h 59min", "source" => "GSM Arena", "numeric_value" => 60.0}
     ],
     "display_max_nits" => 2000
   }},
  {"motorola-razr-50-ultra",
   %{
     ...
     "battery_drain" => [
       %{"value" => "12h 05min", "source" => "GSM Arena", "numeric_value" => 60.0}
     ],
     "display_max_nits" => 3000
   }}
]
...
new_phone_updates = [
  {"apple-iphone-16-pro-max",
   %{
     ...
     "battery_drain" => [
       %{"value" => "17h 18min", "source" => "GSM Arena", "numeric_value" => 87.0}
     ],
     "display_max_nits" => 2500
   }},
  {"apple-iphone-16-pro",
   %{
     "battery_drain" => [
       %{"value" => "14h 17min", "source" => "GSM Arena", "numeric_value" => 71.0}
     ],
     "display_max_nits" => 2500
   }},
  {"apple-iphone-16",
   %{
     "battery_drain" => [
       %{"value" => "15h 42min", "source" => "GSM Arena", "numeric_value" => 79.0}
     ],
     "display_max_nits" => 1600
   }},
  {"samsung-galaxy-s25-ultra",
   %{
     ...
     "battery_drain" => [
       %{"value" => "14h 49min", "source" => "GSM Arena", "numeric_value" => 74.0}
     ],
     "display_max_nits" => 3000
   }},
  {"samsung-galaxy-s25-plus",
   %{
     ...
     "battery_drain" => [
       %{"value" => "14h 26min", "source" => "GSM Arena", "numeric_value" => 72.0}
     ],
     "display_max_nits" => 2600
   }},
  {"samsung-galaxy-s25",
   %{
     ...
     "battery_drain" => [
       %{"value" => "13h 09min", "source" => "GSM Arena", "numeric_value" => 66.0}
     ],
     "display_max_nits" => 2600
   }},
  {"oneplus-13",
   %{
     ...
     "battery_drain" => [
       %{"value" => "15h 28min", "source" => "GSM Arena", "numeric_value" => 77.0}
     ],
     "display_max_nits" => 4500
   }},
  {"xiaomi-15-pro",
  ...
  {"honor-magic-7-pro",
   %{
     ...
     "battery_drain" => [
       %{"value" => "13h 53min", "source" => "GSM Arena", "numeric_value" => 69.0}
     ],
     "display_max_nits" => 5000
   }},
  {"vivo-x200-pro",
   %{
     ...
     "battery_drain" => [
       %{"value" => "15h 09min", "source" => "GSM Arena", "numeric_value" => 76.0}
     ],
     "display_max_nits" => 4500
   }},
  {"nothing-phone-3",
   %{
     "battery_drain" => [
       %{"value" => "12h 56min", "source" => "GSM Arena", "numeric_value" => 65.0}
     ],
     "display_max_nits" => 3000
   }},
  {"motorola-edge-50-neo",
   %{
     "battery_drain" => [
       %{"value" => "13h 29min", "source" => "GSM Arena", "numeric_value" => 67.0}
     ],
     "display_max_nits" => 2000
   }}
]
...
new_phones = [
  ...
  %{
    ...
    specs: %{
      ...
      "headphone_jack" => "No",
      "stability" => [
        %{"value" => "82%", "source" => "GSM Arena", "numeric_value" => 82.0},
        %{"value" => "78%", "source" => "AnandTech", "numeric_value" => 78.0}
      ],
      "cpu_score" => [%{"value" => "8814", "source" => "Geekbench 6", "numeric_value" => 88.0}],
      "display_max_nits" => 2500
    }
  ...
  %{
    ...
    specs: %{
      ...
      "stability" => [%{"value" => "80%", "source" => "GSM Arena", "numeric_value" => 80.0}],
      "gpu_score" => [
        %{"value" => "6850", "source" => "3DMark WL Extreme", "numeric_value" => 82.0}
      ],
      "cpu_score" => [%{"value" => "8100", "source" => "Geekbench 6 MC", "numeric_value" => 89.0}],
      "battery_drain" => [
        %{"value" => "16h 50m", "source" => "GSM Arena", "numeric_value" => 84.0}
      ],
      "display_max_nits" => 2500
    }
  },
  ...
  %{
    ...
    specs: %{
      ...
      "headphone_jack" => "No",
      "stability" => [
        %{"value" => "83%", "source" => "GSM Arena", "numeric_value" => 83.0},
        %{"value" => "80%", "source" => "AnandTech", "numeric_value" => 80.0},
        %{"value" => "81%", "source" => "Tom's Guide", "numeric_value" => 81.0}
      ],
      "display_max_nits" => 3000
    }
  },
  %{
    ...
    specs: %{
      ...
      "ip_rating" => "IP68",
      "headphone_jack" => "No",
      "stability" => [%{"value" => "79%", "source" => "GSM Arena", "numeric_value" => 79.0}],
      "display_max_nits" => 2600
    }
  },
  %{
  ...
  %{
    ...
    specs: %{
      ...
      "gpu_score" => [
        %{"value" => "5350", "source" => "3DMark WL Extreme", "numeric_value" => 71.0},
        %{"value" => "5120", "source" => "GFXBench Aztec", "numeric_value" => 68.0}
      ],
      "cpu_score" => [
        %{"value" => "6410", "source" => "Geekbench 6 MC", "numeric_value" => 76.0},
        %{"value" => "6120", "source" => "AnTuTu 10", "numeric_value" => 73.0}
      ],
      "battery_drain" => [
        %{"value" => "15h 20m", "source" => "GSM Arena", "numeric_value" => 77.0}
      ],
      "display_max_nits" => 3000
    }
  },
  %{
    ...
    specs: %{
      ...
      "stability" => [%{"value" => "76%", "source" => "GSM Arena", "numeric_value" => 76.0}],
      "gpu_score" => [
        %{"value" => "5210", "source" => "3DMark WL Extreme", "numeric_value" => 69.0}
      ],
      "cpu_score" => [%{"value" => "6350", "source" => "Geekbench 6 MC", "numeric_value" => 76.0}],
      "battery_drain" => [
        %{"value" => "14h 10m", "source" => "GSM Arena", "numeric_value" => 71.0}
      ],
      "display_max_nits" => 3000
    }
  },
  ...
  %{
    ...
    specs: %{
      ...
      "headphone_jack" => "No",
      "stability" => [
        %{"value" => "80%", "source" => "GSM Arena", "numeric_value" => 80.0},
        %{"value" => "76%", "source" => "AnandTech", "numeric_value" => 76.0}
      ],
      "gpu_score" => [
        %{"value" => "7200", "source" => "3DMark WL Extreme", "numeric_value" => 85.0}
      ],
      "cpu_score" => [%{"value" => "7700", "source" => "Geekbench 6 MC", "numeric_value" => 86.0}],
      "battery_drain" => [
        %{"value" => "17h 30m", "source" => "GSM Arena", "numeric_value" => 88.0}
      ],
      "display_max_nits" => 4500
    }
  },
  ...
  %{
    ...
    specs: %{
      ...
      "ip_rating" => "IP69",
      "headphone_jack" => "No",
      "stability" => [%{"value" => "78%", "source" => "GSM Arena", "numeric_value" => 78.0}],
      "display_max_nits" => 5000
    }
  },
  %{
...
_ =
  try do
    AnythingCompare.Cache.Storage.update_category(
      "phones",
      AnythingCompare.Catalog.list_products("phones")
    )
...
IO.puts(
  "Seeded #{phone_count} phones with #{map_size(phones_schema)} spec fields (+ benchmarks on flagships)"
)
